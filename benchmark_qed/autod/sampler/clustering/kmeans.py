    ...
    def cluster(
        ...
        **_kwargs: Any,
        ...
        if num_clusters is None:
            ...
            log.info(f"Number of clusters not provided. Defaulting to {num_clusters}.")
        ...
        log.info(
            f"Cluster sizes: min={min(cluster_sizes)}, max={max(cluster_sizes)}, mean={np.mean(cluster_sizes)}"
        )
